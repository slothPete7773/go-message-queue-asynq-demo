...
func (c *UserController) GetAllUsers(w http.ResponseWriter, r *http.Request) {
	...
	c.respondJSON(w, users, http.StatusOK)
}
...
func (c *UserController) UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	user, err := c.service.UpdateUser(id, req.Name, req.Email, req.Age)
	if err != nil {
		c.respondError(w, err.Error(), http.StatusBadRequest)
		return
	}
...
func (c *UserController) DeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	c.respondJSON(w, SuccessResponse{Message: "user deleted successfully"}, http.StatusOK)
}
